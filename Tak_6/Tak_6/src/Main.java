...
public class Main {
    public static void main(String[] args) {
        ...
        Company company1 = new Company("ООО Ромашка", new TaxSystem.UrnIncomeTaxSystem());
        Company company2 = new Company("ИП Петров", new TaxSystem.UrnIncomeMinusExpensesTaxSystem());
        ...
        company2.setTaxSystem(new TaxSystem.UrnIncomeTaxSystem());
